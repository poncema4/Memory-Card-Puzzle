...
(define (process-key a-world a-key)
  (local [;;LoC -> LoC 
    ...
    (if (not (eq? a-world UNINIT-WORLD))
        (if (eq? (world-turn a-world) P1-TURN)
...
(check-expect (process-key INIT-WORLD "1") (local [(define nw (make-world
                                                               (list
                                                                ...
                                                                (make-card 'face-down 'unmatched 1 9))
                                                               (world-turn INIT-WORLD)
                                                               (add1 (world-MC INIT-WORLD))))
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD "2") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD "3") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD "4") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD "5") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD "6") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD "7") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD "8") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD "9") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD "0") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
...
(check-expect (process-key INIT-WORLD3 "0")
              (make-world
               (list
                (make-card 'face-down 'unmatched 1 0)
                (make-card 'face-down 'unmatched 2 1)
...
;;Sample Expressions
(define LW-P1-WIN (place-image (text "!!!YOU WON!!!" 90 'Green)
                       (/ TABLE-WIDTH 2)
                       (/ TABLE-HEIGHT 2)
...
;;Sample tests using sample expressions
(check-expect (draw-last-world FINISHED-P1-WORLD) LW-P1-WIN)
(check-expect (draw-last-world FINISHED-P2-WORLD) LW-P1-LOSS)
