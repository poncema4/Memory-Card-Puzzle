...
(define (process-key a-world a-key)
  (local [;;LoC -> LoC 
    ...
    (if (not (eq? a-world UNINIT-WORLD))
        (if (eq? (world-turn a-world) P2-TURN)
...
(check-expect (process-key INIT-WORLD3 "1") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-up  'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                                (make-card 'face-down 'unmatched 4 3)
                                                                (make-card 'face-down 'unmatched 5 4)
                                                                ...
                                                                (make-card 'face-down 'unmatched 4 6)
                                                                (make-card 'face-down 'unmatched 3 7)
                                                                (make-card 'face-down 'unmatched 2 8)
                                                                (make-card 'face-down 'unmatched 1 9))
                                                               (world-turn INIT-WORLD3)
                                                               (add1 (world-MC INIT-WORLD3))))
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD3 "2") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                                (make-card 'face-down 'unmatched 4 3)
                                                                (make-card 'face-down 'unmatched 5 4)
                                                                (make-card 'face-down 'unmatched 5 5)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD3 "3") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-up   'unmatched 3 2)
                                                                (make-card 'face-down 'unmatched 4 3)
                                                                (make-card 'face-down 'unmatched 5 4)
                                                                (make-card 'face-down 'unmatched 5 5)
                                                                (make-card 'face-down 'unmatched 4 6)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD3 "4") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                                (make-card 'face-up   'unmatched 4 3)
                                                                (make-card 'face-down 'unmatched 5 4)
                                                                (make-card 'face-down 'unmatched 5 5)
                                                                (make-card 'face-down 'unmatched 4 6)
                                                                (make-card 'face-down 'unmatched 3 7)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD3 "5") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                                (make-card 'face-down 'unmatched 4 3)
                                                                (make-card 'face-up   'unmatched 5 4)
                                                                (make-card 'face-down 'unmatched 5 5)
                                                                (make-card 'face-down 'unmatched 4 6)
                                                                (make-card 'face-down 'unmatched 3 7)
                                                                (make-card 'face-down 'unmatched 2 8)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD3 "6") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                                (make-card 'face-down 'unmatched 4 3)
                                                                (make-card 'face-down 'unmatched 5 4)
                                                                (make-card 'face-up   'unmatched 5 5)
                                                                (make-card 'face-down 'unmatched 4 6)
                                                                (make-card 'face-down 'unmatched 3 7)
                                                                (make-card 'face-down 'unmatched 2 8)
                                                                (make-card 'face-down 'unmatched 1 9))
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD3 "7") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                                ...
                                                                (make-card 'face-down 'unmatched 5 4)
                                                                (make-card 'face-down 'unmatched 5 5)
                                                                (make-card 'face-up   'unmatched 4 6)
                                                                (make-card 'face-down 'unmatched 3 7)
                                                                (make-card 'face-down 'unmatched 2 8)
                                                                (make-card 'face-down 'unmatched 1 9))
                                                               (world-turn INIT-WORLD3)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD3 "8") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                                ...
                                                                (make-card 'face-down 'unmatched 5 5)
                                                                (make-card 'face-down 'unmatched 4 6)
                                                                (make-card 'face-up   'unmatched 3 7)
                                                                (make-card 'face-down 'unmatched 2 8)
                                                                (make-card 'face-down 'unmatched 1 9))
                                                               (world-turn INIT-WORLD3)
                                                               (add1 (world-MC INIT-WORLD3))))
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD3 "9") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                                ...
                                                                (make-card 'face-down 'unmatched 4 6)
                                                                (make-card 'face-down 'unmatched 3 7)
                                                                (make-card 'face-up   'unmatched 2 8)
                                                                (make-card 'face-down 'unmatched 1 9))
                                                               (world-turn INIT-WORLD3)
                                                               (add1 (world-MC INIT-WORLD3))))
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD3 "0") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-down 'unmatched 2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                                ...
                                                                (make-card 'face-down 'unmatched 3 7)
                                                                (make-card 'face-down 'unmatched 2 8)
                                                                (make-card 'face-up   'unmatched 1 9))
                                                               (world-turn INIT-WORLD3)
                                                               (add1 (world-MC INIT-WORLD3))))
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'update-world mw))))
(check-expect (process-key INIT-WORLD2 "1") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up   'matched   2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'turn-change mw))))
(check-expect (process-key INIT-WORLD2 "2") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up   'matched   2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'turn-change mw))))
(check-expect (process-key INIT-WORLD2 "3") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up   'matched   2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'turn-change mw))))
(check-expect (process-key INIT-WORLD2 "4") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up   'matched   2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'turn-change mw))))
(check-expect (process-key INIT-WORLD2 "5") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up   'matched   2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'turn-change mw))))
(check-expect (process-key INIT-WORLD2 "6") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up   'matched   2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'turn-change mw))))
(check-expect (process-key INIT-WORLD2 "7") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up   'matched   2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'turn-change mw))))
(check-expect (process-key INIT-WORLD2 "8") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up   'matched   2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'turn-change mw))))
(check-expect (process-key INIT-WORLD2 "9") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up   'matched   2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
                                                   ...
                                                   (define mw (marshal-world nw))]
                                             (make-package nw (list 'turn-change mw))))
(check-expect (process-key INIT-WORLD2 "0") (local [(define nw (make-world
                                                               (list
                                                                (make-card 'face-down 'unmatched 1 0)
                                                                (make-card 'face-up   'matched   2 1)
                                                                (make-card 'face-down 'unmatched 3 2)
...
;;Sample value tests for process-key
(check-expect (process-key INIT-WORLD "0")
              (make-world
               (list
                (make-card 'face-down 'unmatched 1 0)
                (make-card 'face-down 'unmatched 2 1)
...
;;Sample expression test for process-tick
(check-expect (process-tick INIT-WORLD)  PT-W1)
(check-expect (process-tick INIT-WORLD4) PT-W4)

;;Sample values test for process-tick
(check-expect (process-tick INIT-WORLD2)
              (make-world
               (list
                (make-card 'face-down 'unmatched 1 0)
                (make-card 'face-up 'matched 2 1)
...
;;Sample tests using sample expressions for game-over?
...
;;Sample tests using sample values for game-over?
...
(define LW-P2-WIN (place-image (text "!!!YOU WON!!!" 90 'Green)
                       (/ TABLE-WIDTH 2)
                       (/ TABLE-HEIGHT 2)
...
;;Sample tests using sample expressions for draw-last-world
(check-expect (draw-last-world FINISHED-P2-WORLD) LW-P2-WIN)
(check-expect (draw-last-world FINISHED-P1-WORLD) LW-P1-LOSS)
                                                                                         
;;Sampke tests using sample values for draw-last-world
